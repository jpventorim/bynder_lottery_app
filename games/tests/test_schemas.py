...
def test_ballot_in_validate_game_date__within_range():
...
def test_ballot_in_validate_game_date__past_date_fails():
...
def test_ballot_in_validate_game_date__more_than_a_week_fails():
